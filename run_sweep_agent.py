...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "-g",
        type=str,
        help="Which GPUs to use for running agents on. "
    ...
    if verbose:
        print(
            "Note: Showing all stdout and stderr output, as only a single agent is running!"
        )
    else:
        print(
            "Note: Catching all stdout and stderr output as multiple agents run in parallel!"
        )
    print("=" * 100)
    print()
